...
namespace UnitTest.ORM
{
    ...
    public class MySQLMappingTest
    {
        ...
        public void SetUp()
        {
            ...
            _emit = CoreFactory.CreateDialectProvider("my").CreateMappingSQLEmit(CoreFactory.ObjectMapInfoCache);
        }
        ...
        public void TestFindByOrderAsc()
        {
            ...
            Assert.AreEqual("SELECT `ID`, `Name`, `Birth`, `Gender` FROM `Person` ORDER BY `Birth` ASC LIMIT 0, 10", sql);
        }
        ...
        public void TestFindByOrderDesc()
        {
            ...
            Assert.AreEqual("SELECT `ID`, `Name`, `Birth`, `Gender` FROM `Person` ORDER BY `Birth` DESC LIMIT 0, 5", sql);
        }
        ...
        public void TestFindByOrderTop()
        {
            ...
            Assert.AreEqual("SELECT `ID`, `Name`, `Birth`, `Gender` FROM `Person` WHERE 1 = 1 ORDER BY `Birth` ASC LIMIT 0, 10", sql);
        }
        ...
        public void TestFindByLocalVar()
        {
            ...
            Assert.AreEqual("SELECT `ID`, `Name`, `Birth`, `Gender` FROM `Person` WHERE `Birth` = '2000-01-01 00:00:00'", sql);
        }
        ...
        public void TestFindByComplex1()
        {
            ...
            Assert.AreEqual("SELECT `ID`, `Name`, `Birth`, `Gender` FROM `Person` WHERE (`Birth` > '2000-01-01 00:00:00') AND (`Gender` = 1)", sql);
        }
        ...
        public void TestFindByComplex2()
        {
            ...
            Assert.AreEqual("SELECT `ID`, `Name`, `Birth`, `Gender` FROM `Person` WHERE (`Birth` > '2000-01-01 00:00:00') AND NOT (`Gender` = 1)", sql);
        }
        ...
        public void TestInsert()
        {
            ...
            Assert.AreEqual("INSERT INTO `Person`(`Name`, `Birth`, `Gender`) VALUES('R', '2000-01-01 00:00:00', 0)", sql);
        }
        ...
        public void TestUpdate()
        {
            ...
            Assert.AreEqual("UPDATE `Person` SET `Name` = 'R', `Birth` = '2000-01-01 00:00:00', `Gender` = 0 WHERE `ID` = 10", sql);
        }
